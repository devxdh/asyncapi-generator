...
const { validateTemplateConfig } = require('../lib/templates/config/validator');
const fs = require('fs');
...
describe('Template Configuration Validator', () => {
  ...
  it('Validation throw error if renderer not supported', () => {
    ...
    expect(() => validateTemplateConfig(templateConfig, templateParams)).toThrow('We do not support \'non_existing\' as a renderer for a template. Only \'react\' is supported.');
  });
